...
namespace Characters.Enemies.Scripts
{
    public abstract class NavigationHelpers
    {
        ...
        public static Vector3 GetClosestPointAroundRadius(Vector3 agentPosition, Vector3 center, float radius, int numLocations)
        {
            ...
            {
                Debug.DrawRay(point.position - new Vector3(0.25f, 0.0f, 0.0f), new Vector3(0.5f, 0.0f, 0.0f), new Color(point.score, 0.0f, 0.0f, 1.0f));
                Debug.DrawRay(point.position - new Vector3(0.0f, 0.25f, 0.0f), new Vector3(0.0f, 0.5f, 0.0f), new Color(point.score, 0.0f, 0.0f, 1.0f));
            }
