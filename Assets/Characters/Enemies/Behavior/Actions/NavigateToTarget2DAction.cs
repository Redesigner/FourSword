...
namespace Unity.Behavior
{
    ...
    partial class NavigateToTarget2DAction : Action
    {
        ...
        {
            return new Vector2(Target.Value.transform.position.x - Agent.Value.transform.position.x, Target.Value.transform.position.y - Agent.Value.transform.position.y).magnitude;
        }
